...
ol.Map.prototype.render = function() {
  ...
  // vermutung: solang animationDelay aktiv, dann tue nichts und setze dadruch rekursiven Aufruf von renderFrame fort
  if (this.animationDelay_.isActive()) {
    // pass
    //window.console.log(this.freezeRenderingCount_, 'pass', this.animationDelay_.isActive());
 
 // vermutung: falls animationDelay nicht aktiv starte rekursiven Aufruf von renderFrame
  } else if (this.freezeRenderingCount_ === 0) {
    this.animationDelay_.fire();
    //window.console.log(this.freezeRenderingCount_, 'fire', this.animationDelay_.isActive());

// vermutung: sonst keine Ahnung
  } else {
    this.dirty_ = true;
  }
};
...
ol.Map.prototype.renderFrame_ = function(time) {
  ...
  //window.console.log(this.tileQueue_);
 ...
 * Set the view for this map.
 */
ol.Map.prototype.rerender = function() {
...
ol.Map.createOptionsInternal = function(options) {
  ...
  var layerGroup = (options.layers instanceof ol.layer.Group) ?
    options.layers : new ol.layer.Group({
