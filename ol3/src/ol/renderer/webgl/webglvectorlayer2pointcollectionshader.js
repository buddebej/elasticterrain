 ...
 * @type {string}
 */
ol.renderer.webgl.vectorlayer2.shader.PointCollectionFragment.DEBUG_SOURCE = 'precision highp float;\nuniform vec4 u_color;\n\nvoid main(void) {\n  gl_FragColor = u_color;\n}\n';
 ...
 * @type {string}
 */
ol.renderer.webgl.vectorlayer2.shader.PointCollectionFragment.OPTIMIZED_SOURCE = 'precision highp float;uniform vec4 d;void main(void){gl_FragColor=d;}';
