...
ol.renderer.webgl.tiledemlayer.shader.Locations = function(gl, program) {
   ...
   * @type {WebGLUniformLocation}
   */
  this.u_shading = gl.getUniformLocation(
      program, goog.DEBUG ? 'u_shading' : 'm');

  /**
   * @type {WebGLUniformLocation}
   */
  this.u_shadingOpacity = gl.getUniformLocation(
      program, goog.DEBUG ? 'u_shadingOpacity' : 'r');
